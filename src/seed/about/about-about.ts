            ...
            children: [
              {
                ...
                format: 0,
                version: 1,
                text: "A fortunate aspect in my own life revealed to me how astrology can be more than a source of information — it can be, like other practices, a space that helps us make sense of what might otherwise feel like chaos. That's what Bright Shadow Studio is. I took the name from a note in my own birth chart — a reminder that both light and shadow are essential parts of what it means to grow.",
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                format: 0,
                version: 1,
                text: "Founded in 2020, Bright Shadow Studio was born during a challenging and turbulent time in the world — which felt like exactly the right moment for it.",
              },
            ],
          },
        ],
